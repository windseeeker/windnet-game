#ifndef __PQ_PREPAREDSTATEMENT_H__
#define __PQ_PREPAREDSTATEMENT_H__
...
public:
    ...
    void bindText(size_t param, const std::string &value);
    void bindBytea(size_t param, const std::string &value);
